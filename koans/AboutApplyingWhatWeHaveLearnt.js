...
describe("About Applying What We Have Learnt", function() {
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
    ...
    var sum = _.range(1, 1000).reduce(function(acc, curr) {
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    // map products to an array of arrays containing ingredients
    // flatten the array
    // reduce the array to count each occurence of each ingredient, 
    // and store it in ingredientCount as a key/value pair.
    _(products).chain()
    .map(function(product) { return product.ingredients; })
    .flatten()
    .reduce(function(counts, ingreds){
      counts[ingreds] = (counts[ingreds] || 0) + 1;
      return counts
    }, ingredientCount);
